...
public:
	...
	{
		const float p = 15.0f;
		uboParams.lights[0].position = glm::vec4(-p, -p*0.5f, -p, 1.0f);
		uboParams.lights[1].position = glm::vec4(-p, -p*0.5f,  p, 1.0f);
		uboParams.lights[2].position = glm::vec4( p, -p*0.5f,  p, 1.0f);
		uboParams.lights[3].position = glm::vec4( p, -p*0.5f, -p, 1.0f);

		uboParams.lights[0].colorAndRadius = glm::vec4(1.f, 0.f, 0.f, 30.1f);
		uboParams.lights[1].colorAndRadius = glm::vec4(0.f, 1.f, 0.f, 30.1f);
		uboParams.lights[2].colorAndRadius = glm::vec4(0.f, 0.f, 1.f, 30.1f);
		uboParams.lights[3].colorAndRadius = glm::vec4(1.f, 1.f, 0.f, 30.1f);

		if (!paused)
		{
			uboParams.lights[0].position.x = sin(glm::radians(timer * 360.0f)) * 20.0f;
			uboParams.lights[0].position.z = cos(glm::radians(timer * 360.0f)) * 20.0f;
			uboParams.lights[1].position.x = cos(glm::radians(timer * 360.0f)) * 20.0f;
			uboParams.lights[1].position.y = sin(glm::radians(timer * 360.0f)) * 20.0f; 
		}
